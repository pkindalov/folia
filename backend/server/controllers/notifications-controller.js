...
// album_photos_added, page_reaction, page_comment, comment_reply, and
// comment_reaction show the specific photo they reference instead (see
// album-notifications.js) — every other type has no thumbnail at all.
const COVER_THUMBNAIL_TYPES = ['album_shared', 'album_updated'];
const PAGE_THUMBNAIL_TYPES = [
  'album_photos_added',
  'page_reaction',
  'page_comment',
  'comment_reply',
